...
const remainingRouter: AppRouteRecordRaw[] = [
 ...
 
  {
    ...
    children: [
      {
        path: 'purchaseList/index',
        component: () => import('@/views/mall/product/purchaseList/index.vue'),
        name: 'purchaseListIndex',
        meta: {
          noCache: false, // 需要缓存
          canTo: true,
          title: '采购列表',
          activeMenu: '/mall/product/purchaseList/index'
        }
      },
      {
        path: 'purchaseList/purchaseDeatil',
        component: () => import('@/views/mall/product/purchaseList/purchaseDeatil.vue'),
        name: 'purchaseDeatil',
        meta: {
          noCache: false, // 需要缓存
          canTo: true,
          title: '采购项详情',
          activeMenu: '/mall/product/purchaseList'
        }
      },
      {
        path: 'spu/add',
