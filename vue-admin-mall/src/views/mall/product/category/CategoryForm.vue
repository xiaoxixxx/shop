  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    <el-form ref="formRef" :model="formData" :rules="formRules" label-width="120px" v-loading="formLoading">
      <el-form-item label="上级分类" prop="parentId">
        <el-cascader v-model="formData.parentId" :options="categoryList" :props="props" style="width: 100%;" />
      </el-form-item>
      <el-form-item label="分类名称" prop="name">
        <el-input v-model="formData.name" placeholder="请输入分类名称" />
      </el-form-item>

      <el-form-item label="分类名称(法语)" prop="nameTranslations.nameFr">
        <el-input v-model="formData.nameTranslations.nameFr" placeholder="请输入分类名称(法语)" />
      </el-form-item>
      <el-form-item label="分类名称(英语)" prop="nameTranslations.nameEn">
        <el-input v-model="formData.nameTranslations.nameEn" placeholder="请输入分类名称(英语)" />
      </el-form-item>
      <!-- nameTranslations -->
...
const formRules = reactive({
  ...
  'nameTranslations.nameEn': [
    { required: true, message: '分类名称(英语)不能为空', trigger: 'blur' }
  ],
  'nameTranslations.nameFr': [
    { required: true, message: '分类名称(法语)不能为空', trigger: 'blur' }
  ],
