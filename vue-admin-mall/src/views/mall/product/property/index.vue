<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <!-- <el-table-column align="center" label="属性名称(英语)" prop="propertyNameTranslation.nameEn" min-width="150" />
      <el-table-column align="center" label="属性名称(法语)" prop="propertyNameTranslation.nameFr" min-width="150" /> -->

      <el-table-column :show-overflow-tooltip="true" align="center" label="备注" prop="remark" />

      <!-- <el-table-column align="center" label="备注(英语)" prop="propertyRemarkTranslation.remarkEn" min-width="150" />

      <el-table-column align="center" label="备注(法语)" prop="propertyRemarkTranslation.remarkFr" min-width="150" /> -->
