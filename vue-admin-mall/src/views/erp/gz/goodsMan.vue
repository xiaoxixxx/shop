<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" row-key="id" default-expand-all>
      ...
      <el-table-column label="商品类目" align="center" prop="storageTypeName" />
...
const getTypeList = async () => {
  const res = await StorageApi.getStatusList()
  typeList.value = res
  typeList.value
  getList()
}
...
const getList = async () => {
  loading.value = true
  try {
    const data = await StorageApi.getStorageGoodsList(queryParams)
