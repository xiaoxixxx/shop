...
<template>
  ...
  <view>
    <view class="pdlr10 pdtb10  between  topNav">
      ...
      <view class="text_center center  f17  text_bold ">{{t('login.log_phone_inp')}}</view>
      <view class="right ww24 hh24">
      </view>
    </view>

    <view class="mt20 pdlr12">
      <view class="f16 ">{{t('set.pho_h1')}}</view>
      <view class="colorCCC f12  mt4" v-if="userStoreInfo.$state.userInfo.mobile">{{t('set.pho_h2')}}
        {{addStarNum(userStoreInfo.$state.userInfo.mobile)}}</view>
      <view class="colorCCC f12  mt4" v-else>{{t('set.pho_h3')}}</view>
      <view class="mt60">

        <view class="between ">
          <view class="flex col_center">
            <img src="@/static/icons/mobile.png" class="ww24 hh24" />
            <view class="ml12 f14">
        ...
        <view class="mt12 ml40 pb16 pwdInp ">
          <input type="number" :placeholder="t('set.pho_h4')" v-model="formData.mobile"
            maxlength="11">
