...
import { baseUrl, websocketPath } from '../config';
import { copyValueToTarget } from '../../../../comm/useGoods.js';
import { getRefreshToken } from '../../../../comm/request.ts';
...
export function useWebSocket(opt) {
  const options = reactive({
    // url:"ws://192.168.1.23:48080/infra/ws?token=" + getRefreshToken(), // ws 地址
	url:"wss://dev.waisj.com:3004/infra/ws?token=" + getRefreshToken(), // ws 地址
