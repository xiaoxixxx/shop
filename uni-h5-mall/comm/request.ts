...
import { goLoginDialog } from "./goLogin";
...
const config = {
	...
	"Authorization":""
					...
					var now_version = localStorage.getItem('version') 
	...
	return new Promise(async (resolve, reject) => {
		...
		function next() {
			uni.request({
				...
				url: import.meta.env.SHOPRO_DEV_BASE_URL + options.url,
				success(res: any) {
					const { code, data, msg } = res.data;
					if(res.data.version !== localStorage.getItem('version') &&  res.data.version){
